...
public class RobotContainer {
  ...
  private final CommandXboxController m_driverController = new CommandXboxController(USB.xBoxController);
  private final CommandXboxController m_nathanDebugController = new CommandXboxController(USB.leftJoystick);

  private double MaxSpeed = TunerConstants.kSpeedAt12Volts.in(MetersPerSecond); // kSpeedAt12Volts desired top speed
  private double MaxAngularRate = RotationsPerSecond.of(SWERVE.kMaxRotationRadiansPerSecond)
