    ...
    switch (m_stage) {
      ...
      case L1:
        if (m_selectedGamePiece.get() == ROBOT.GAME_PIECE.ALGAE)
          m_elevator.setDesiredPosition(
              ELEVATOR_SETPOINT.PROCESSOR.getSetpointMeters() / ELEVATOR.sprocketRotationsToMeters);
      ...
      case L2:
        if (m_selectedGamePiece.get() == ROBOT.GAME_PIECE.ALGAE) {
          ...
          m_elevator.setDesiredPosition(
              ELEVATOR_SETPOINT.LEVEL_2.getSetpointMeters() / ELEVATOR.sprocketRotationsToMeters);
        }
        break;
      case L3:
        if (m_selectedGamePiece.get() == ROBOT.GAME_PIECE.ALGAE) {
          ...
          m_elevator.setDesiredPosition(
              ELEVATOR_SETPOINT.LEVEL_3.getSetpointMeters() / ELEVATOR.sprocketRotationsToMeters);
        }
        break;
      case L4:
        if (m_selectedGamePiece.get() == ROBOT.GAME_PIECE.ALGAE) {
          m_elevator.setDesiredPosition(
              ELEVATOR_SETPOINT.NET.getSetpointMeters() / ELEVATOR.sprocketRotationsToMeters);
        } else {
          m_elevator.setDesiredPosition(
              ELEVATOR_SETPOINT.LEVEL_4.getSetpointMeters() / ELEVATOR.sprocketRotationsToMeters);
        }
        break;
      default:
        break;
