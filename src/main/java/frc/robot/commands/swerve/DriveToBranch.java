    ...
    return Commands.defer(
        () -> {
          ...
          if (Controls.isBlueAlliance()) {
            nearestBranchPose =
                robotToNearestBranch[0].nearest(Arrays.asList(FIELD.BLUE_CORAL_BRANCHES));
          } else {
            nearestBranchPose =
                robotToNearestBranch[0].nearest(Arrays.asList(FIELD.RED_CORAL_BRANCHES));
          }
          robotToNearestBranch[1] = FIELD.CORAL_TARGETS.getCoralPoseToTargetPose(nearestBranchPose);
