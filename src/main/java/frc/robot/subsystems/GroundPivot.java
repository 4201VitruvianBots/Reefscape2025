...
public class GroundPivot extends SubsystemBase {
    ...
    // Simulation Code
    private final SingleJointedArmSim m_groundPivotSim =
    ...
    private final NetworkTable groundPivotTab =
    ...
    public void testInit() {
      groundPivotTab.getDoubleTopic("kP").publish().set(PIVOT.kP);
      groundPivotTab.getDoubleTopic("kI").publish().set(PIVOT.kI);
      groundPivotTab.getDoubleTopic("kD").publish().set(PIVOT.kD);
      groundPivotTab
      ...
      m_kP_subscriber = groundPivotTab.getDoubleTopic("kP").subscribe(PIVOT.kP);
      m_kI_subscriber = groundPivotTab.getDoubleTopic("kI").subscribe(PIVOT.kI);
      m_kD_subscriber = groundPivotTab.getDoubleTopic("kD").subscribe(PIVOT.kD);
      m_velocitySubscriber =
          groundPivotTab
              .getDoubleTopic("MotionMagicCruiseVelocity")
      ...
      m_setpointSubscriber = groundPivotTab.getDoubleTopic("Setpoint Degrees").subscribe(m_desiredRotation.in(Degrees));
    }
    ...
    public void simulationPeriodic() {
      ...
      m_pivotMotorSimState.setRawRotorPosition(
          Radians.of(m_endEffectorSim.getAngleRads() * PIVOT.gearRatio));
      m_pivotMotorSimState.setRotorVelocity(
          RadiansPerSecond.of(m_endEffectorSim.getVelocityRadPerSec() * PIVOT.gearRatio));
