...
public final class SWERVE {
  ...
  public static final class DRIVE {
    ...
    public static double kTrackWidth = Units.inchesToMeters(24); // TODO update track width
    public static final double kWheelBase = Units.inchesToMeters(24); // TODO update wheel base
