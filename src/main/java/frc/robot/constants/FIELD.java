...
public final class FIELD {
  public static final double fieldLength = Units.inchesToMeters(651.25); // TODO update field length
  public static final double fieldWidth = Units.inchesToMeters(315.5); // TODO update field width
  public static final double tapeWidth = Units.inchesToMeters(2.0); // TODO update tape width
  public static final double aprilTagWidth = Units.inchesToMeters(6.5); // TODO update April Tag width

  // TODO add scoring locations
